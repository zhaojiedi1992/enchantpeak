    ...
    private void buildBoots() {
        ...
        for (Item item : boots) {
            records.add(new ItemEnchantRecord(item, List.of(
                    ...
                    new EnchantGroup("保护+深海探索者", List.of(e(Enchantments.ALL_DAMAGE_PROTECTION, 4), e(Enchantments.DEPTH_STRIDER, 3), e(Enchantments.FALL_PROTECTION, 4), e(Enchantments.UNBREAKING, 3), e(Enchantments.MENDING, 1))),
                    new EnchantGroup("保护+冰霜行者", List.of(e(Enchantments.ALL_DAMAGE_PROTECTION, 4), e(Enchantments.FROST_WALKER, 2), e(Enchantments.FALL_PROTECTION, 4), e(Enchantments.UNBREAKING, 3), e(Enchantments.MENDING, 1))),
                    new EnchantGroup("火焰保护+深海探索者", List.of(e(Enchantments.FIRE_PROTECTION, 4), e(Enchantments.DEPTH_STRIDER, 3), e(Enchantments.FALL_PROTECTION, 4), e(Enchantments.UNBREAKING, 3), e(Enchantments.MENDING, 1)))
            )));
        }
    }
